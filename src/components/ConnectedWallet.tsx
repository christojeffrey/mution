  ...
  return (
    <div className="">
      <div className="home-headings mx-10 text-[#474646]">
        ...
        <button className="text-3xs bg-[#D9D9D9] bg-opacity-40 rounded-lg px-2 my-1 font-bold transition ease-in-out hover:-translate-y-1 hover:scale-105">
          <Link className="p-0" to="/wallets">
            LIHAT LAINNYA
          </Link>
        </button>
      </div>
